...
function WebSupportBubble() {
  const { ConversationProvider } = require("@elevenlabs/react");
...
export default function SupportBubble() {
  if (Platform.OS === "web") {
    return <WebSupportBubble />;
  }
  return <NativeSupportBubble />;
}
